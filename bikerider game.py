...
def game_init():
    pygame.init()
    pygame.display.set_caption('Bike Rider/kishore')
    game_icon=pygame.image.load('images/transport.png')
...
def game_intro():
    ...
    while intro:
        ...
        textSurf, textRect = text_object("Let's Race !", largeText)
...
def game_loop():
    ...
    while not gameExit:
        ...
        load_image(thing_startx, thing_starty, 'images/snowman1.jpg')
        load_image(80, tree_y_left, 'images/trees.jpg')
        load_image(700, tree_y_right, 'images/trees.jpg')
        load_image(x,y, 'images/bike.jpg')
        ...
        if x > display_width - bike_width - 150 or x < 150 :
        ...
        if y < (thing_starty + thing_height) and y+ bike_height >= thing_starty + thing_height:
            if x > thing_startx and x < (thing_startx + thing_width) or x + bike_width > thing_startx \
            and x + bike_width < thing_startx + thing_width :
                crash(x, y)
